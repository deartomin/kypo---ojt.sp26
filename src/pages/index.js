          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <p>
                ...
                sinh viên thực hành các kịch bản tấn công và phòng thủ.
              </p>
            </div>
            ...
            <div className={styles.card}>
              ...
              <p>
                ...
                cộng đồng cùng phát triển các bài tập.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.sectionDark}>
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <p>
                KYPO là một nền tảng cyber range chạy trên hạ tầng cloud, được
            ...
            <div className={styles.card}>
              ...
              <p>
                ...
                các hệ thống mạng phức tạp mô phỏng các tình huống an ninh thực
                tế.
              </p>
            </div>
            ...
            <div className={styles.card}>
              ...
              <h3>Giao diện Web</h3>
              <p>
                Người dùng truy cập hệ thống thông qua giao diện web, trong khi
                hạ tầng phía dưới được quản lý bằng OpenStack.
              </p>
            </div>
          </div>
        </section>
